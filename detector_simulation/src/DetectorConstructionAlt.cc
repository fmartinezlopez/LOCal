...
DetectorConstructionAlt::DetectorConstructionAlt()
{}

DetectorConstructionAlt::~DetectorConstructionAlt()
{}

G4VPhysicalVolume *DetectorConstructionAlt::Construct()
{
    ...
    solidDetector = new G4Box("solidDetector", xWorld/nRows-0.5*cm, xWorld/nCols-0.5*cm, 0.01*m);
...
void DetectorConstructionAlt::ConstructSDandField()
{
